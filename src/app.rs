    ...
    pub fn get_config_keys(&self) -> Vec<ConfigKey> {
        match self {
            ...
            EdgeAppConfigBlock::PQSettings => vec![
                ...
                ConfigKey::EdgeAppPassthroughGammaMode,
                ConfigKey::EdgeAppPassthroughGammaParameter,
            ],
...
pub enum ConfigKey {
    ...
    EdgeAppPassthroughGammaMode,
    EdgeAppPassthroughGammaParameter,
    // PortSettings
...
impl Display for ConfigKey {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let msg = match self {
            ...
            ConfigKey::EdgeAppPassthroughGammaMode => "Gamma Mode",
            ConfigKey::EdgeAppPassthroughGammaParameter => "Gamma Parameter",
            ConfigKey::EdgeAppPassthroughMetadataMethod => "Output Tensor Method",
            ConfigKey::EdgeAppPassthroughMetadataStorageName => "Output Tensor Storage Name",
            ConfigKey::EdgeAppPassthroughMetadataEndpoint => "Output Tensor Endpoint",
            ConfigKey::EdgeAppPassthroughMetadataPath => "Output Tensor Metadata Path",
            ConfigKey::EdgeAppPassthroughMetadataEnabled => "Output Tensor Enabled",
